...
- Solution URL: [GitHub](https://github.com/edkiada/weatherApp)
- Live Site URL: [Countries App](https://edkiada.github.io/weatherApp/)
...
- [Open-Meteo API](https://open-meteo.com/) - fetch weather data
